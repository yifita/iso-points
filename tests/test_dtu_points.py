...
from DSS.utils.point_processing import resample_uniformly, remove_outliers, denoise_normals
...
from DSS.misc.visualize import plot_3D_quiver, plot_cuts
from DSS.training.losses import CosSimilarityLoss, NormalLengthLoss
...
class Shape(object):
    ...
    def __init__(self, points, n_points, normals=None):
        ...
        self.points = resample_uniformly(points, normals=normals, iters=10, repulsion_mu=0.5, neighborhood_size=31, reproject=False)
...
def smooth_point_clouds(iso_points, iso_normals):
    """ sample more on the edge? """
    pass
